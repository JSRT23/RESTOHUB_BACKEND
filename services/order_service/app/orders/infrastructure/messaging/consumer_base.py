# order_service/app/orders/infrastructure/messaging/consumer_base.py
import json
import logging
import time
...
class BaseConsumer:
    ...
    def _connect(self) -> None:
        ...
        self.channel.exchange_declare(
            exchange=get_exchange(),       # ✅ función, no constante
            exchange_type="topic",
            durable=True,
        )
        self.channel.exchange_declare(
            exchange=get_dlx(),            # ✅ función, no constante
    ...
    def start(self) -> None:
        while True:
            try:
                ...
                logger.info(f"🚀 Order consumer '{self.service}' escuchando...")
