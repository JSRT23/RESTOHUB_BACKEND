...
def get_publisher() -> "EventPublisher":
    """Singleton — un canal reutilizado por proceso."""
    global _publisher
...
class EventPublisher:
    ...
    ✅ Canal reutilizado (no conexión TCP por evento)
    ✅ Publisher confirms (broker confirma recepción)
    ✅ Mensajes persistentes (delivery_mode=2)
    ✅ Envelope estándar con event_id, timestamp, version
    """
    ...
    def __init__(self):
        ...
        logger.info("📤 EventPublisher (staff) listo con publisher confirms")
    ...
    def publish(self, event_type: str, data: dict) -> bool:
        envelope = {
            ...
            "service_origin": getattr(settings, "SERVICE_NAME", "staff_service"),
            "version":        "1.0",
            "data":           data,
        }
