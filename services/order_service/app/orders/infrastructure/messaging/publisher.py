# order_service/app/orders/infrastructure/messaging/publisher.py
import json
import logging
import uuid
...
class EventPublisher:
    def __init__(self):
        ...
        logger.info("📤 EventPublisher (order) listo")
    ...
    def publish(self, event_type: str, data: dict) -> bool:
        envelope = {
            ...
            "service_origin": getattr(settings, "SERVICE_NAME", "order_service"),
            "version":        "1.0",
            "data":           data,
        }
